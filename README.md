...
- Large Language Models (LLMs) & Reasoning Models  
- Multimodal Learning & Retrieval-Augmented Generation (RAG)  
- Reinforcement Learning (RL) & Agentic AI Systems  
- AI in Healthcare & Bio-signal Analysis (EEG, ECG)  
...
- Self-supervised representation learning on EEG signals

#### 🏥 Medical RAG Systems (OHRI, Canada)
